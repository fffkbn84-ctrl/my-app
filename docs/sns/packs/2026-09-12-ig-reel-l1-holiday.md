...
> ⚠️ **このキットの画像方針は置き換え済み（2026-09-19）。新しい回で参照しない。**
> ここで指定している「木の台座つきミニチュアジオラマ」は、9/14〜9/17 の3投稿で確立した
> **背景 `#F5EEE6` の単色スタイルより古い**。リールもプロフィールのグリッドに並ぶため、
> ここだけジオラマにすると2つのアカウントが混ざって見える。
> **入口リールの正は `docs/sns/series/nyuguchi-reel.md`。**
> 文の設計・動きの付け方・音・CTA・セルフQA は新しい型に引き継いである。
...
#結婚相談所 #婚活 #お見合い #婚活中の人と繋がりたい #結婚相談所選び
```

- **ハッシュタグは5個まで。** それ以上は投稿できない。多く付けても薄まるだけなので、顕在ワード2つ（結婚相談所・婚活）＋内容に一致するもの2つ＋回遊タグ1つで組む
