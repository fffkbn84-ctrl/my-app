...
export const STORIES: Story[] = [
  {
    ...
    quote:
      "ここからは、新しい出会いを増やす時期ではない気がしています。いま会っている方を、もう少し深く知る時間にしたい",
    ...
    agencyName: "",
    body: [
      "エンジニアの仕事をしています。ずっと、仕事に打ち込んできました。面白かったですし、後悔もしていません。",
      "変わったのは、まわりの話題のほうでした。気がついたら、同僚と話していても、友人と会っても、子育ての話が中心になっていました。保育園がどうとか、熱を出したとか、そういう話です。",
      "最初は、自分には関係のない話として聞いていました。でもあるとき、自分もそちらに行きたいのだと気づきました。焦っていたわけではないと思います。ただ、行きたい場所がはっきりしただけでした。",
      "それで、結婚相談所に登録しました。",
      "正直に言うと、あまり期待していませんでした。40代で、仕事ばかりしてきて、そんなに簡単に会えるものではないだろうと思っていたんです。",
      "始めてみたら、思っていたよりお会いできました。良い意味で驚いています。",
      "いまは、毎週どこかで、お見合いか、交際中の方とのデートか、どちらかは入っています。予定が埋まっていること自体が、自分でも少し意外です。",
      "これが誰にでも起きることだとは思っていません。時期やタイミングもあると思いますし、自分の場合はたまたま合う流れだった、という感覚に近いです。",
      "そうやって続けているうちに、気になる方が数人できました。",
      "ここからは、新しい出会いを増やす時期ではない気がしています。人数を増やすより、いま会っている方を、もう少し深く知る時間にしたい。そう思うようになりました。",
      "何回か会っただけでは、まだ分からないことのほうが多いです。仕事のこと、休みの日のこと、お金のこと、家族のこと。話していないことが、たぶんまだたくさんあります。",
      "しばらくは、そういう時間にしようと思っています。",
      "※ この物語は、ご本人の同意を得て、イニシャル表記で掲載しています。所属している相談所名は非公開です。",
    ],
    pullQuote:
      "焦っていたわけではないと思います。ただ、行きたい場所がはっきりしただけでした",
    ...
    faq: [
      {
        ...
        a: "相談所には幅広い年代の方が登録しています。40代からの活動も珍しくありません。年代によってお見合いの組みやすさに差が出ることはありますが、それは活動の進み方の違いであって、早い遅いという評価ではありません。始める時期の適切さは、ご本人が動きたいと思えたかどうかで決まります。",
      },
      {
        q: "結婚相談所では、複数の方と同時に交際してもよいのですか。",
        a: "多くの相談所では、真剣交際に進む前の段階であれば、複数の方と並行して交際することが標準的な進め方とされています。お相手も同じように複数の方と会っていることが前提です。人数を絞るタイミングに決まりはなく、担当の方と相談しながら決めていきます。",
      },
      {
        q: "お見合いやデートは、どのくらいの頻度が普通ですか。",
        a: "決まった頻度はありません。週に1回ほど何らかの予定が入る方もいれば、月に1〜2回のペースで進める方もいます。仕事の状況や、会ったあとに考える時間がどれくらい必要かによって、無理のない間隔は人それぞれ変わります。担当の方に伝えておくと、申し込みの本数を調整してもらえます。",
      },
    ],
    relatedWeather: [
