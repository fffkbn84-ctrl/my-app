...
export const STORIES: Story[] = [
  {
    ...
    agencyName: "",
    body: [
      "これまでお付き合いをしたことはありますが、結婚には至りませんでした。周りも落ち着いてきたので、そろそろかなと思って東京で活動を始めました。",
      "登録してすぐに出会った方がいてそのまま交際に進み、いろいろなことを話しました。そのうえで僕からお別れを切り出しました。",
  ...
  },
  {
    ...
    agencyName: "",
    body: [
      "若い頃に結婚して子どもをもうけましたが、その後離婚しています。",
