...
export const STORIES: Story[] = [
  {
    // ご本人からの寄稿。名前表記・写真なし・相談所名は非公開（consent.agency=false）。
    // 後悔がいまも続いていることがこの物語の中身なので、前向きな着地や教訓に書き換えない。
    // お別れしたお相手が特定されないよう、交際中のやり取りの中身には触れない。
    id: "masashi-30s-owakare-koukai",
    quote:
      "何人の方とお会いしても、なぜか思い出すのは最初に出会った方のことでした",
    title: "どうしてあの時、お別れを選んでしまったのだろう",
    author: "まさし さん",
    age: "35歳",
    ageBand: "30代後半",
    status: "活動中",
    ...
    agencyName: "",
    body: [
      "35歳です。東京で活動しています。これまでお付き合いをしたことはありますが、結婚には至りませんでした。",
      "周りも落ち着いてきたので、そろそろかなと思って活動を始めました。3ヶ月ほど前のことです。",
      "登録してすぐに出会った方がいて、交際に進みました。いろいろなことを話しました。そのうえで僕からお別れを切り出しました。",
      "それからは新しい出会いと向き合おうと思っていました。実際に何人もの方とお会いしています。",
      "それなのに思い出すのは、なぜか最初に出会った方のことでした。",
      "どうしてあの時僕はお別れを選んでしまったのだろう。何度もそう考えてしまいます。",
      "今は少し後悔しているというのが正直な現状です。",
      "※ この物語はご本人の同意を得て掲載しています。所属している相談所名は非公開です。",
    ],
    pullQuote: "今は少し後悔しているというのが正直な現状です",
    tags: ["30代男性", "東京", "活動中", "交際終了"],
    sympathyCount: 0,
    accentColor: "#5A6A86",
    accentSoft: "#E6EAF2",
    faq: [
      {
        q: "結婚相談所で自分から交際を終えたあと、後悔することはありますか。",
        a: "相談所の交際は比較的短い期間で続けるかどうかを判断することが多く、あとから別の方と会う中で気持ちが動くことがあります。後悔が出てくること自体はめずらしいことではありません。その気持ちをどう扱うかは、すぐに決めなくてもかまいません。",
      },
      {
        q: "一度お別れした相手と、もう一度やり取りすることはできますか。",
        a: "交際終了後の扱いは、所属している相談所や連盟の規定によって異なります。お相手の意思が前提になるため、自分から直接連絡を取るのではなく、まず担当の方に相談するのが一般的です。",
      },
      {
        q: "新しい方と会っても前の方を思い出してしまうのは、よくあることですか。",
        a: "比べるつもりがなくても、最初に深く話した方の印象は残りやすいものです。思い出すことを無理に止めようとするより、何が心に残っているのかを言葉にしてみると、次に会う方との時間の過ごし方が見えてくることがあります。",
      },
    ],
    relatedWeather: [
      { slug: "wandering-clouds", label: "迷い雲の気持ちとは" },
  ...
  {
    // ご本人からの寄稿。名前表記・写真なし・相談所名は非公開（consent.agency=false）。
    // 不安とワクワクが同時にあることをそのまま残す。どちらかに寄せて書き換えない。
    id: "asami-40s-mama-mo-shiawase",
    quote:
      "これからどんな出会いがあるか不安もあります。でも思っていなかった幸せを想像して、ワクワクもしています",
    title: "「ママも幸せになってね」と言われて、自分を振り返った",
    author: "あさみ さん",
    age: "40代",
    ageBand: "40代",
    status: "活動中",
    ...
    agencyName: "",
    body: [
      "地方に住んでいます。若い頃に結婚して子どもをもうけましたが、その後離婚しています。",
      "それからは子どもを育てることに必死でした。脇目もふらず働いてきました。",
      "子育てが落ち着いてきた頃、子どもから「ママも幸せになってね」と言われました。",
      "そのとき初めて自分を振り返った気がします。子どもと一緒に過ごせただけで、私は幸せだと思っていたんです。",
      "子どもとよく話し合いました。その結果、結婚相談所に登録することにしました。活動を始めてまだ1ヶ月も経っていません。",
      "これからどんな出会いがあるのか不安もあります。でも思っていなかった幸せを想像して、ワクワクもしています。",
      "※ この物語はご本人の同意を得て掲載しています。所属している相談所名は非公開です。",
    ],
    pullQuote: "子どもと一緒に過ごせただけで、私は幸せだと思っていたんです",
    tags: ["40代女性", "地方", "子育て", "活動中"],
    sympathyCount: 0,
    accentColor: "#86604A",
    accentSoft: "#F4EAE2",
    faq: [
      {
        q: "子育てが落ち着いてから結婚相談所を始める人はいますか。",
        a: "子育てがひと段落してから活動を始める方はいます。始める時期に決まった正解はなく、ご本人が動きたいと思えたときが始めどきです。お子さんと話し合ってから登録する方もいます。",
      },
      {
        q: "子どもがいることは、お相手にいつ伝わるのですか。",
        a: "多くの相談所ではお子さんの有無がプロフィールの項目になっていて、お見合いの前からお相手に伝わる形が一般的です。会ってから打ち明けるかどうかで悩まずにすむ仕組みになっています。詳しい扱いは相談所ごとに異なるので、担当の方に確認できます。",
      },
      {
        q: "活動を始めたばかりで不安があるのは普通ですか。",
        a: "始めたばかりの時期は、仕組みにも流れにもまだ慣れていないため不安が出やすい時期です。不安と楽しみが同時にあるのはめずらしいことではありません。気になることを担当の方に言葉にして渡しておくと、進め方を一緒に調整できます。",
      },
    ],
    relatedWeather: [
      { slug: "morning-mist", label: "朝もやの気持ちとは" },
      { slug: "pre-dawn", label: "夜明け前の気持ちとは" },
    ],
    consent: {
      web: true,
      sns: true,
  ...
  {
    // ご本人からの寄稿。イニシャル表記・写真なし・相談所名は非公開（consent.agency=false）。
    // 「思ったよりうまくいっている」話。読む人を追い詰めないよう、一般化しない一文を本文に残す。
    id: "yk-40s-fukaku-shiru-jikan",
    quote:
      "ここからは新しい出会いを増やす時期ではない気がしています。いま会っている方をもう少し深く知る時間にしたい",
    title: "出会いを増やす時期は、もう終わったのかもしれない",
    author: "Y.K さん",
    age: "42歳",
    ageBand: "40代",
    status: "活動中",
    ...
    tags: ["40代", "エンジニア", "活動中", "交際中"],
    sympathyCount: 0,
    accentColor: "#4A7A86",
    accentSoft: "#E2F0F2",
    faq: [
      {
        q: "40代から結婚相談所を始めるのは、遅いのでしょうか。",
        a: "相談所には幅広い年代の方が登録していて、40代からの活動も珍しくありません。年代によってお見合いの組みやすさに差が出ることはありますが、それは活動の進み方の違いであって早い遅いという評価ではありません。始める時期の適切さはご本人が動きたいと思えたかどうかで決まります。",
      },
      {
        q: "結婚相談所では、複数の方と同時に交際してもよいのですか。",
        a: "多くの相談所では真剣交際に進む前の段階であれば、複数の方と並行して交際することが標準的な進め方とされています。お相手も同じように複数の方と会っていることが前提です。人数を絞るタイミングに決まりはなく、担当の方と相談しながら決めていきます。",
      },
      {
        q: "お見合いやデートは、どのくらいの頻度が普通ですか。",
        a: "決まった頻度はありません。週に1回ほど何らかの予定が入る方もいれば、月に1〜2回のペースで進める方もいます。仕事の状況や会ったあとに考える時間がどれくらい必要かによって、無理のない間隔は人それぞれ変わります。担当の方に伝えておくと申し込みの本数を調整してもらえます。",
      },
    ],
    relatedWeather: [
