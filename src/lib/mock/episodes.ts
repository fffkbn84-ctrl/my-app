...
export const episodesData: Episode[] = [
  {
    ...
    quote:
      "「ふたりへで田中さんの口コミを読んだとき、『この人なら話せるかも』と初めて思いました。面談前日まで緊張していたのに、始まったら20分で緊張が溶けていた。自分でも驚きました。」",
  ...
  },
  {
    ...
    story: [
      ...
      "ふたりへで鈴木カウンセラーの口コミに「再婚の方に寄り添ってくれた」という声を見つけ、予約を決意。初回面談で「再婚は全く問題ない」と言われた瞬間、肩の荷が降りた気がしたといいます。",
    ],
    quote:
  ...
  },
  {
    ...
    story: [
      ...
      "ふたりへでオンライン専門の林カウンセラーを見つけ、「通勤時間ゼロで相談できる」ことを知り予約。仕事の繁忙期には活動ペースを落とす柔軟な対応をしてもらいながら、11ヶ月後に成婚。",
    ],
    quote:
