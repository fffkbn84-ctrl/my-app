...
- [ ] **【追加】no-show 返金ルールの法務同期**：請求履歴UIを「ユーザー不来訪の未実施は請求しない」に変更済み。契約書(`agency-agreement.md`)・事業者向け特商法(`tokushoho-agency-b2b.md`)・営業デッキ slide6 返金脚注を**この新ルールに統一**（旧「面談不成立＝課金確定」を是正）。顧問弁護士レビュー前提。
