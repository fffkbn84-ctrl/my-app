...
| **C：法務・契約** | **1 週** | **利用規約・特商法表記の本番値差替・規約レビュー** | **🟢 主要 3 PR 完了（2026-05-23）：my-app 法務／counselor 法務／マーケ opt-in UI。残：実値差替・弁護士レビュー** |
...
1. **Phase C 残作業**（実値が固まり次第）
   ...
   - ✅ 2026-05-23 完了：マーケティングメールオプトイン UI（PR #8）/ counselor 法務ページ（PR #7）
2. **営業準備**（実値差替完了後に着手）
