...
- [ ] **木曜1枚リールの次の候補：間取り「同じ間取り、4つの暮らし」**（`ig-strategy` §15 ①-2）。夜の窓の数字を見てから作る。試作プロンプトは `docs/sns/packs/ig-reel-madori-trial.md`（ふうかさんが試作中）ふうかさんが生成 → Claude が 9:16・文字入れ・7秒 MP4。
